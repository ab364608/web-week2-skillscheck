...
let faveColors = ['red', 'orange', 'grey'];
...
let me = {
    firstName: 'Ben',
    superHeroName: 'Badboy Ben',
    homeTown: 'Flower Mound',
    superPowers: ['kicking ass and taking names', 'flying', 'superspeed'],
...
let superPower = me.superPowers;
let powerXP = me.superPowerXP;
let image = me.profileImage
